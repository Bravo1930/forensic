...
const projects = [
  {
    ...
    col2: "https://images.higgs.ai/?default=1&output=webp&url=https%3A%2F%2Fd8j0ntlcm91z4.cloudfront.net%2Fuser_38xzZboKViGWJOttwIXH07lWA1P%2Fhf_20260412_055344_5eff02e0-87a5-41ce-b64f-eb08da8f33db.png&w=1280&q=85",
  },
  {
    num: "02",
    category: "Personal",
        ...
        <div className="flex items-start justify-between mb-6 sm:mb-8 md:mb-10">
          <div className="flex items-start gap-4 sm:gap-6 md:gap-10">
            ...
            <div className="pt-2 sm:pt-3 md:pt-4">
              <span className="text-[10px] sm:text-xs font-medium uppercase tracking-widest text-[#D7E2EA]/50">
                {project.category}
              </span>
              <h3
...
export default function ProjectsSection() {
  return (
    <section className="relative bg-[#0C0C0C] rounded-t-[40px] sm:rounded-t-[50px] md:rounded-t-[60px] -mt-10 sm:-mt-12 md:-mt-14 z-10 px-5 sm:px-8 md:px-10 pb-20 sm:pb-28 md:pb-36">
      <h2
        className="hero-heading font-black uppercase text-center leading-none tracking-tight pt-20 sm:pt-24 md:pt-32 mb-10 sm:mb-14 md:mb-20"
